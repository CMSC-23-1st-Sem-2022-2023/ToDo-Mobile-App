    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          buildInfo(Icons.person, 'Name:     ', TodoPage.user!.name),
          buildInfo(
              Icons.celebration, 'Birthday:     ', TodoPage.user!.birthday),
          buildInfo(
              Icons.location_pin, 'Location:     ', TodoPage.user!.location),
          buildInfo(Icons.article, 'Bio:     ', TodoPage.user!.bio),
        ],
      ),
    );
  }

  // Container widget for showing the information
